...
| V6 | §5.2 | urbanemissions `AQI_bulletins` coverage end + CSV schema | DEFERRED-M2 | Out of M1 scope. |
| V7 | §5.2 | CPCB daily bulletin URL pattern | DEFERRED-M2 | Out of M1 scope. |
